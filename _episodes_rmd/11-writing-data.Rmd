...
keypoints:
- "Guardar gráficas desde RStudio usando el botón de <kbd>Export</kbd>."
...
```
Puedes guardar una gráfica desde Rstudio usando el botón de <kbd>Export</kbd> en la
...
puedes detener la iteración en cada paso para dar clic en <kbd>Export</kbd> para
cada una.
