...
gatos <- data.frame(color = c("calicó", "negro", "tabby"),
                      peso = c(2.1, 5.0, 3.2),
                      e_gusta_la_cuerda = c(1, 0, 1))
gatos 
```
...
Para que funcione, debemos tener `nrow(cats)` = `length(age)`. Vamos a sobrescribir el contenido de los gatos con nuestro nuevo marco de datos.
