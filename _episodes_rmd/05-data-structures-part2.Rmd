...
Ahora, ¿qué tal si agregamos filas utilizando la función `rbind`?, en este caso, la última vez vimos que las filas de un *data frame* están compuestas por listas:
...
Un factor es un tipo de datos en R, el cual es una categoría (por ejemplo, color) con la que R puede hacer ciertas operaciones. Por ejemplo:
...
nlevels(colores)
```
El orden de los factores tambien puede reorganizarse.
