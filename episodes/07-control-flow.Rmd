...
> ```
>
> A modo de ejemplo aquí hay un bucle while
...
> {: .r}
>
> Los bucles `while()` no siempre serán la elección apropiada. Debes ser particularmente cuidadoso
> de que tu condición se cumpla y no terminar en un bucle infinito.
{: .callout}
...
> probar si el país comienza con una 'B' y graficar la esperanza de vida
...
> > ```
> >
> > Pero cuando evaluamos este comando obtenemos los índices de la variable del factor `country` que comienza con "B".
